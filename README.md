# 🌟 openclaw - Fully Automated OpenClaw Docker Images
...
3. **Set Up OpenClaw**
   ...
   - Use the command to pull the image from the Docker registry:
     ```
     docker pull eliott0557/openclaw
     ```
   - After successfully pulling the image, run OpenClaw with the following command:
     ```
...
4. **Access OpenClaw**
   ...
   - Usually, it runs on `http://localhost:8080`. Open your browser and enter this address to start using OpenClaw.
